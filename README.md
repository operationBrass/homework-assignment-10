...
WHEN I start the applic
WHEN I decide to finish building my team
THEN I exit the application, and the HTML is generatedation
THEN I am prompted to enter the team manager’s name, employee ID, eomail address, and ffice number
